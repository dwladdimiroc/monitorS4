...
public class CreateTrainData {
	...
	static public void main(String args[]){
		...
		String sentiParams[] = {"sentidata", "/home/deb/workspace/myApp/extra/SentiStrength/spanish/", "trinary"};
		sentiStrength.initialise(sentiParams);	

		EarthQuakeLexEvaluator eqLex=new EarthQuakeLexEvaluator("/home/deb/workspace/myApp/extra/earthQuakeLex.csv");
		eqLex.processDict();

		LexiconEvaluator elhPol = new LexiconEvaluator("/home/deb/workspace/myApp/extra/ElhPolar_es.csv");
		elhPol.processDict();



		try {
			ZipFile zf = new ZipFile("/home/deb/workspace/myApp/data/processed_tweets.csv.zip");
